...
const Footer = () => {
  return (
    ...
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content items-center p-4 fixed bottom-0">
      <aside className="grid-flow-col gap-4 md:place-self-center md:justify-self-start">
        <svg
          width="36"
          height="36"
          viewBox="0 0 24 24"
      ...
      <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end text-sm">
        ...
        <a href="/refund-policy" target="_blank" className="hover:underline">Refund Policy</a>
