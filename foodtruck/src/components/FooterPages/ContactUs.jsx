...
const faqs = [
  {
    q: "Where is my order?",
    a: "Track your order in real-time via the Orders tab. If tracking hasn't updated in 30+ minutes, contact us with your Order ID.",
  },
  {
    q: "Can I change my delivery address?",
    a: "Address changes are only possible before the restaurant accepts your order. Contact us immediately after placing the order.",
  },
  {
    q: "My food arrived cold / incorrect",
    a: "We're sorry! Report the issue via the app within 24 hours — go to Orders → Report Issue. We'll investigate and process a refund if applicable.",
  },
  {
    q: "How do I cancel my order?",
    a: "Cancellations are possible only before the restaurant begins preparation. Open the order in the app and tap 'Cancel Order'.",
  },
  {
    q: "How do I apply a promo code?",
    a: "Add items to your cart, go to checkout, and enter the promo code in the 'Apply Coupon' field. Codes are case-sensitive.",
  },
];
    ...
    >
      ...
      <div className="mesh border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-20">
          <p className="text-orange-400 text-xs font-medium tracking-widest uppercase mb-4">
            FoodTruck Support
          </p>
          ...
          <p className="text-gray-400 max-w-md text-lg leading-relaxed">
            From missing items to account questions — our team is ready. Pick
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 space-y-20">
        {/* Contact Channels */}
        <section>
          <h2 className="font-cabinet text-2xl font-bold mb-6 text-gray-200">
            Reach Us Directly
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {channels.map((ch) => {
              ...
              return (
                <div
                  key={ch.label}
                  className={`${v.bg} border ${v.border} rounded-2xl p-6 cursor-pointer hover:scale-[1.02] transition-transform`}
                >
                  <div className="text-3xl mb-4">{ch.icon}</div>
                  <div className="flex items-center gap-2 mb-1">
                    <p className={`font-cabinet font-bold text-lg ${v.text}`}>
                      {ch.label}
                    </p>
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full ${v.badge}`}
                    >
                      {ch.badge}
                    </span>
                  </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <section>
            ...
            {submitted ? (
              <div className="bg-green-500/10 border border-green-500/30 rounded-2xl p-10 text-center">
                ...
                <h3 className="font-cabinet text-2xl font-bold text-green-400 mb-2">
                  Message Received!
                </h3>
                <p className="text-gray-400 text-sm">
                  We'll get back to you at{" "}
                  <span className="text-white">{form.email}</span> within 24–48
                  hours.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="field-wrap bg-gray-900 border border-gray-800 rounded-xl px-4 py-3">
                  ...
                  <select
                    ...
                    className="block w-full text-white text-sm mt-1 bg-gray-900 [&>option]:bg-gray-900 [&>option]:text-white appearance-none cursor-pointer focus:outline-none"
                  >
                    {["Order Issue", "Refund Request", "Account Help", "Restaurant Feedback", "Technical Bug", "Other"].map(o => (
                      <option key={o} className="bg-gray-900 text-white">{o}</option>
                    ))}
                  </select>
                </div>
          ...
          <section>
            ...
            <div className="mt-8 bg-gray-900 border border-gray-800 rounded-2xl p-6">
              <h3 className="font-cabinet font-bold text-white mb-4">
                🏢 Our Office
              </h3>
              <div className="space-y-2 text-sm text-gray-400">
                <p>FoodTruck Technologies Pvt. Ltd.</p>
                <p>No.42/A, Deivasigamanipuram,</p>
                <p>Round Road,</p>
                <p>Dindigul, Tamil Nadu — 624005</p>
                <p className="text-gray-600 mt-3">Mon–Dri · 10am–6pm IST</p>
              </div>
            </div>
          </section>
        </div>
